...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Finds a Person",
            description = "Finds a specific People by your ID",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Export Person data as PDF",
            description = "Export a specific Person data as PDF by his ID",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Updates a specific Person",
    ...
    @Operation(summary = "Disables a Person",
            description = "Disables a specific People by your ID",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
